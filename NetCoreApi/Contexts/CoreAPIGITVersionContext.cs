...
namespace CoreApiGITVersion.Contexts
{
    public partial class CoreAPIGITVersionContext : DbContext
    {
        ...
        public virtual DbSet<TTokenAuthentication> TTokenAuthentication { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TTokenAuthentication>(entity =>
            {
                entity.HasKey(e => e.TTokenId)
                    .HasName("PK__tTokenAu__0B78DB940F975522");

                entity.ToTable("tTokenAuthentication");

                entity.HasIndex(e => new { e.TUserId, e.AccessExpiredDate })
                    .HasName("NonClusteredIndex-20191210-103246");

                entity.HasIndex(e => new { e.TUserId, e.TokenExpired })
                    .HasName("NonClusteredIndex-20191210-103233");

                entity.Property(e => e.TTokenId).HasColumnName("tTokenId");

                entity.Property(e => e.AccessExpiredDate).HasColumnType("datetime");

                entity.Property(e => e.AccessToken).HasMaxLength(255);

                entity.Property(e => e.RefreshExpiredDate).HasColumnType("datetime");
                ...
                entity.HasOne(d => d.TUser)
                    .WithMany(p => p.TTokenAuthentication)
                    .HasForeignKey(d => d.TUserId)
                    .HasConstraintName("FK_tTokenAuthentication_tUser");
            });
